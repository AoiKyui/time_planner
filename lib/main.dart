...
class _SplitDashboardState extends State<SplitDashboard> {
  ...
  // 3. NEW: Interactive Schedule Data
  ...
  // Two controllers for the schedule row
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              const Text('🎯 TOP 3 PRIORITIES', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.amber)),
                          ...
                          // TO-DO LIST HEADER
                          const Text('📝 TO-DO LIST', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.greenAccent)),
                          const SizedBox(height: 8),
                        ...
                        children: [
                          const Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text('SCHEDULE TIME', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueAccent)),
                            ],
                          ),
                          const SizedBox(height: 12),

                          // Dual Input Layout for Time and Task
                          Row(
                            children: [
                              SizedBox(
                                width: 75, // Narrow box optimized for typing simple times (e.g., 09:00 AM)
                                child: TextField(
                                ...
                                children: List.generate(_scheduleTimes.length, (index) {
                                  return Padding(
                                    ...
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(_scheduleTimes[index], style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.blueAccent, fontSize: 13)),
                                        const SizedBox(width: 16),
                                        Expanded(child: Text(_scheduleTasks[index], style: const TextStyle(fontSize: 13))),
                                        IconButton(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(_allPrioritiesCompleted ? 'Enjoy an hour of video games! You earned it!' : 'Complete all 3 priorities above to unlock your reward!', style: const TextStyle(fontSize: 14)),
                  ],
                ),
              ],
            ),
